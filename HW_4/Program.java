...
class TicketProvider{
    ...
    /**
     * Метод для поиска билетов по заданным параметрам.
     *
    ...
    /**
     * Метод для покупки билета с использованием номера карты.
     *
     * @param clientId Идентификатор клиента.
    ...
    /**
     * Метод для проверки билета с использованием QR-кода.
     *
